...
class user_profile(models.Model):
    ...
    biography = models.CharField(max_length = 1000, null=True, default = "")
    dorm = models.CharField(max_length = 1000, null=True, default="")
    phone_number = models.CharField(max_length = 14, null=True, default="")
    contact_email = models.CharField(max_length = 1000, null=True, default = "")
    first_name = models.CharField(max_length = 1000, null=True, default="")
    last_name = models.CharField(max_length = 1000, null=True, default="")
